...
import { FirstMateToolkitHandlersLive } from "./toolkits/firstMate/handlers.ts";
import { FirstMateToolkit } from "./toolkits/firstMate/tools.ts";
import {
...
export const layer = Layer.mergeAll(
  ...
  FirstMateToolkitRegistrationLive,
