...
import * as FirstMateRequestDecisionReactor from "../src/orchestration/FirstMateRequestDecisionReactor.ts";
...
import * as FirstMateTurnReviewReactor from "../src/orchestration/FirstMateTurnReviewReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(FirstMateTurnReviewReactor.FirstMateTurnReviewReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
